...
--
-- Host: 127.0.0.1
-- Generation Time: 08-Mar-2016 às 20:34
...
(1, 'Contato #1jose1111ddssxasqweas'),
(2, 'Contato #2'),
(3, 'Contato #3'),
(4, 'Contato #4'),
(5, 'Contato #5');
...
(1, 2, 1, 'contato1_email1joses@exxzemsasplo.com'),
(2, 1, 2, 'contato2_email1@exemplo.com'),
(3, 2, 2, 'contato2_email1@exemplo.com');
...
--
ALTER TABLE `contato_email`
ADD CONSTRAINT `contato_email_ibfk_1` FOREIGN KEY (`id_contato`) REFERENCES `contato` (`id_contato`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `contato_telefone`
ADD CONSTRAINT `contato_telefone_ibfk_1` FOREIGN KEY (`id_contato`) REFERENCES `contato` (`id_contato`) ON DELETE CASCADE ON UPDATE CASCADE,
